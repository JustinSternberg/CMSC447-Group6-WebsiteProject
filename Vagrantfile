...
Vagrant.configure(2) do |config|
  ...
  config.hostsupdater.aliases = ["webapp.dev"]

  # Create a public network, which generally matched to bridged network.
  # Bridged networks make the machine appear as another physical device on
  # your network.
  #config.vm.network "public_network", ip: "192.168.33.9"
  ...
  #config.vm.synced_folder "./webapp/", "/srv/webapp/", create: true
  config.vm.synced_folder "./webapp/", "/srv/webapp", create: true
  ...
  #  sudo apt-get update
  #  sudo apt-get install -y apache2 dkms
  #SHELL
end
